...
const NotifyScreen = lazy(() => import("./pages/Channels/NotifyScreen"));
  ...
  <Routes>
    ...
    >
      ...
      <Route
        ...
        element={
          <RoleBasedRoute requiredRole={routes.find((r) => r.path === "/channels/notify")?.roles}>
            <NotifyScreen />
          </RoleBasedRoute>
        }
      />
      ...
      <Route path="channels" element={<Navigate to="/channels/notify" replace />} />
      <Route path="facebook" element={<Navigate to="/channels/notify" replace />} />
      <Route path="order-notify" element={<Navigate to="/channels/zalo/orders" replace />} />
      <Route path="channels/zalo" element={<Navigate to="/channels/notify" replace />} />
      <Route path="channels/zalo/features" element={<Navigate to="/channels/notify" replace />} />
      <Route path="channels/zalo/settings" element={<Navigate to="/channels/notify" replace />} />
      <Route path="settings/zalo" element={<Navigate to="/channels/notify" replace />} />
      <Route
        path="shipping"
        element={
      ...
      <Route path="finance/reconcile" element={<Navigate to="/finance/ledger" replace />} />
